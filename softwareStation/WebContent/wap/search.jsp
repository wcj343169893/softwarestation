...
<c:choose>
	...
	<c:otherwise>
		...
		<c:set var="page" value="${pageResult}"></c:set>
			...
			<a href="searchmodel.php?keyword=${keyword }&amp;p=1&amp;mid=${mid }">首页</a> <c:if test="${page.pageNo!=1}"><a href="searchmodel.php?keyword=${keyword }&amp;p=${page.pageNo-1 }&amp;mid=${mid }">上页</a> </c:if>
					<c:if test="${page.pageNo<page.pageTotal}"><a href="searchmodel.php?keyword=${keyword }&amp;p=${page.pageNo+1 }&amp;mid=${mid }">下页</a> </c:if> <a
				href="searchmodel.php?keyword=${keyword }&amp;p=${page.pageTotal}&amp;mid=${mid }">尾页</a>${page.recTotal}个 
